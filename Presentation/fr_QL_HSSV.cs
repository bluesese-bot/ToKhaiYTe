...
{
    public partial class fr_QL_HSSV : Form
    {
        public fr_QL_HSSV()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["H11:H11"].Value = "Lớp";
            exRange.Range["I11:I11"].Value = "Khoa";
            exRange.Range["J11:J11"].Value = "SDT";
            exRange.Range["K11:K11"].Value = "Số TBHYT";
            exRange.Range["L11:L11"].Value = "Email";
            exRange.Range["M11:M11"].Value = "Trạng Thái";
            ...
            exRange = exSheet.Cells[6][hang + 15]; //Ô A1 
            exRange.Range["A1:F1"].MergeCells = true;
            exRange.Range["A1:F1"].Font.Bold = true;
            exRange.Range["A1:F1"].Font.Italic = true;
            exRange.Range["A1:F1"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignRight;
            exRange = exSheet.Cells[10][hang + 17]; //Ô A1 
